...
import ru.designtop.networking.data.network.RestApi;
import ru.designtop.networking.data.network.dto.HitsDTO;
import ru.designtop.networking.ui.adapter.PhotosAdapter;

public final class MainActivity extends AppCompatActivity {

    private static final int LAYOUT = R.layout.activity_main;

    public static final String DEFAULT_SEARCH_REQUEST = "pie";
    ...
    protected void onStart() {
        super.onStart();
        setupUx();
        loadPics(DEFAULT_SEARCH_REQUEST);
    }
    ...
    private void validateAndLoadPics(@Nullable String query) {
    ...
    private void checkResponseAndShowState(@NonNull Response<DefaultResponse<List<HitsDTO>>> response) {
        ...
        final DefaultResponse<List<HitsDTO>> body = response.body();
        if (body == null) {
            showState(State.HasNoData);
            return;
        }

        final List<HitsDTO> data = body.getData();
        if (data == null) {
            showState(State.HasNoData);
            return;
        }
